...
After an initial Exploratory Data Analysis, the models are trained and saved as pickle files. Once performance has been assessed, the predicted data from the best model is analyzed.
